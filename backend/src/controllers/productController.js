...
export const listAdmin = asyncHandler(async (req, res) => res.json(await req.services.products.list(req.query, { includeInactive: true })))
...
export const updateStatus = asyncHandler(async (req, res) => res.json(await req.services.products.updateStatus(req.params.id, req.body, req.user.id)))
